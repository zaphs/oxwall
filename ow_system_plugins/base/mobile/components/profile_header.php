...
class BASE_MCMP_ProfileHeader extends OW_MobileComponent
{
    ...
    public function onBeforeRender() 
    {
        ...
        $avatarData = BOL_AvatarService::getInstance()->getDataForUserAvatars([$this->user->id]);
        ...
        if ( $showPresence )
        {
            $onlineInfo = BOL_UserService::getInstance()->findOnlineStatusForUserList([$this->user->id]);
